    ...
    <section class="mb-4">
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="4"
                 data-sm-items="4" data-xs-items="4" data-arrows='true'>
...
<?php endif; ?><?php /**PATH D:\My Work\Website\public_html\resources\views/frontend/partials/featured_products_section.blade.php ENDPATH**/ ?>