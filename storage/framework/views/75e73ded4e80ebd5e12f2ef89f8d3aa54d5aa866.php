                        ...
                        <table class="table table-responsive table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php $__currentLoopData = Session::get('compare'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td>
                                            <?php if(\App\Models\Product::find($item)->subsubcategory != null): ?>
                                                <?php echo e(\App\Models\Product::find($item)->subsubcategory->getTranslation('name')); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/comfortwear/web/comfortwearbd.com/public_html/resources/views/frontend/view_compare.blade.php ENDPATH**/ ?>