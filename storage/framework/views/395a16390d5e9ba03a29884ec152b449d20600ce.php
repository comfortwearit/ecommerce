                            ...
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <?php else: ?>
                                        <td class="w-50 fw-600"><?php echo e(translate('Phone')); ?>:</td>
                                        <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Work\Website\public_html\resources\views/frontend/order_confirmed.blade.php ENDPATH**/ ?>