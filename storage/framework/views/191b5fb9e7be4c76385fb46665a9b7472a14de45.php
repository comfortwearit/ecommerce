                        ...
                        <div class="shadow-sm bg-white p-4 rounded mb-4">
                            <div class="row gutters-5">
                               ...
                               <?php if(Auth::check()): ?>
                                ...
                                <?php elseif(!Auth::check() && !isset($address)): ?>
                                    <div class="col-md-6 mx-auto mb-3" >
                                        <div class="border p-3 rounded mb-3 c-pointer text-center bg-white h-100 d-flex flex-column justify-content-center" onclick="add_new_address()">
                                            <i class="las la-plus la-2x mb-3"></i>
                                            <div class="alpha-7"><?php echo e(translate('Add New Address')); ?></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Work\Website\public_html\resources\views/frontend/shipping_info.blade.php ENDPATH**/ ?>